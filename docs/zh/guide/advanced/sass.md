...
所以为了解决这个问题，本项目在 [v4.3.0](https://github.com/PanJiaChen/doc-site/pull/3040)修改为`dart-sass`进行构建，它能在保证性能的前提下大大简化用户的安装成本。通过这个 [issue](https://github.com/PanJiaChen/doc-site/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc)下面相关的评论就可以知道，安装 `node-sass` 是多么麻烦的一件事。
...
具体可见该： [Pull Request](https://github.com/PanJiaChen/doc-site/pull/3040)
