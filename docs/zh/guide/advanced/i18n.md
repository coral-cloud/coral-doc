...
[完整代码](https://github.com/PanJiaChen/doc-site/blob/master/src/lang/index.js)。
同时将当前 `lang` 语言存在 `cookie`之中，为了下次打开页面能记住上次的语言设置。

# 全局 lang

代码地址: [@/lang](https://github.com/PanJiaChen/doc-site/tree/master/src/lang)
目前配置了英文和中文两种语言。
...
如果你有国际化需求的请使用 [i18n 分支](https://github.com/PanJiaChen/doc-site/tree/i18n)，它与 master 同步更新。
