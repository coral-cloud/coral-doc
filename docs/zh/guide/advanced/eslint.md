...
所有的配置文件都在 [.eslintrc.js](https://github.com/PanJiaChen/doc-site/blob/master/.eslintrc.js) 中。
...
在 [v3.8.1](https://github.com/PanJiaChen/doc-site/releases/tag/v3.8.1)版本之后，增加了[eslint-plugin-vue](https://github.com/vuejs/eslint-plugin-vue)来更好的校验 vue 相关代码。
...
如果你不想使用 ESLint 校验（不推荐取消），只要找到 [vue.config.js](https://github.com/PanJiaChen/doc-site/blob/master/vue.config.js) 文件。
