...
::: tip 代码地址
[@/layout/components/Sidebar](https://github.com/PanJiaChen/doc-site/tree/master/src/layout/components/Sidebar)
:::

这里同时也改造了 `element-ui` 默认侧边栏不少的样式，所有的 css 都可以在 [@/styles/sidebar.scss](https://github.com/PanJiaChen/doc-site/blob/master/src/styles/sidebar.scss) 中找到，你也可以根据自己的需求进行修改。
...
::: tip unique-opened
你可以在[Sidebar/index.vue](https://github.com/PanJiaChen/doc-site/blob/master/src/layout/components/Sidebar/index.vue)中设置`unique-opened`来控制侧边栏，是否只保持一个子菜单的展开。
:::
...
::: tip 代码地址
[@/components/Breadcrumb](https://github.com/PanJiaChen/doc-site/blob/master/src/components/Breadcrumb/index.vue)
:::
...
可以通过`default-openeds`来进行设置，首先找到 [侧边栏代码](https://github.com/PanJiaChen/doc-site/blob/master/src/layout/components/Sidebar/index.vue)
